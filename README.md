...
3. Search for "Remora custom component for Home Assistant"
...
1. Go to **Settings** → **Devices & Services**
2. Find **Remora custom component for Home Assistant**
...
Find all entities in **Settings** → **Devices & Services** → **Remora custom component for Home Assistant** → click on the device.
...
4. Check the integration diagnostics (Settings → Devices & Services → Remora custom component for Home Assistant → 3 dots → Download diagnostics)
...
**Made with ❤️ by [@laurentlemercier][user_profile]**

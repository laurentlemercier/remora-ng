...
This document describes all configuration options and settings available in the Remora custom component for Home Assistant custom integration.
...
```yaml
blueprint:
  name: Remora custom component for Home Assistant Alert

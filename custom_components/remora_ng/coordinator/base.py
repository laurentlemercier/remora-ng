"""
Core DataUpdateCoordinator implementation for remora_ng.
...
from custom_components.remora_ng.api import RemoraApiClientAuthenticationError, RemoraApiClientError
...
class RemoraDataUpdateCoordinator(DataUpdateCoordinator):
    ...
    async def _async_update_data(self) -> Any:
        ...
        except RemoraApiClientAuthenticationError as exception:

...
def _verify_response_or_raise(response: aiohttp.ClientResponse) -> None:
    ...
    Raises:
        RemoraApiClientAuthenticationError: For 401/403 errors.
        aiohttp.ClientResponseError: For other HTTP errors.

    """
    if response.status in (401, 403):
        msg = "Invalid credentials"
        raise RemoraApiClientAuthenticationError(
            msg,
        )
...
class RemoraApiClient:
    ...
    async def async_get_data(self) -> Any:
        ...
        Raises:
            RemoraApiClientAuthenticationError: If authentication fails.
            RemoraApiClientCommunicationError: If communication fails.
            RemoraApiClientError: For other API errors.
    ...
    async def _api_wrapper(
        ...
        try:
            ...
            raise RemoraApiClientCommunicationError(
                msg,
            ) from exception

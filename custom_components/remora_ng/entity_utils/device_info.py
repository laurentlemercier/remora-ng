"""Device info utilities for remora_ng."""
...
def create_device_info(
    ...
    return DeviceInfo(
        ...
        name=name or "Remora custom component for Home Assistant",
        manufacturer=manufacturer or "Remora custom component for Home Assistant",
...
def get_device_identifiers(config_entry: ConfigEntry) -> set[tuple[str, str]]:
    ...
    Example:
        ...
        >>> # Returns: {('remora_ng', 'entry_id_value')}
    """
